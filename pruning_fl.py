...
parser.add_argument('--beta', type=float, default=0.5, help='Beta parameter (unbalance rate) for Dirichlet distribution')

parser.add_argument('--sparsity', type=float, default=0.3, help='sparsity from 0 to 1')
